          ...
          <div className="flex items-center justify-between h-20 lg:h-24">
            ...
            <div className="hidden lg:flex items-center gap-3 flex-shrink-0">
              ...
              <a href="https://www.facebook.com/vitalvendingsales" target="_blank" rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-11 h-11 flex items-center justify-center rounded-lg text-[#6B7280] hover:text-[#1B2A4A] transition-colors duration-200">
            ...
            <button
              ...
              className="lg:hidden p-3 rounded-md text-[#3D4D5C] hover:bg-[#F4F6F8] transition-colors duration-200"
