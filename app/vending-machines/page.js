...
const MACHINES = [
  ...
  { id: 'ams39classicsingle', category: 'snack', brand: 'AMS', name: 'AMS 39 Classic Snack Machine (Single Coil)', desc: 'Reliable non-refrigerated snack vending, dependable for offices, schools, and break rooms', specs: ['Single coil', '72"H', '35" or 39"W'], price: '$4,557', img: '/static-assets/vvs_product_catalog/images/ams/ams-39-classic-single-coil.png', coilImg: '/static-assets/vvs_product_catalog/images/ams/single-coil-dual-coil-comparison.png' },
  { id: 'ams39classicdual', category: 'snack', brand: 'AMS', name: 'AMS 39 Classic Snack Machine (Dual Spiral Coil)', desc: 'Higher capacity, same footprint, designed for higher-volume locations', specs: ['Dual spiral coils', '72"H', '35" or 39"W'], price: '$4,799', img: '/static-assets/vvs_product_catalog/images/ams/ams-39-classic-dual-coil.png', coilImg: '/static-assets/vvs_product_catalog/images/ams/single-coil-dual-coil-comparison.png' },
  ...
  { id: 'amslowtempsingle', category: 'combo', brand: 'AMS', name: 'AMS Low Temp 4 Wide (Single Coil)', desc: 'Rugged and reliable snack vending with modern electronics. Designed for reliable product dispensing and straightforward operation, with the Sensit delivery system confirming each selected product reaches the delivery area. Backed by a 3-year warranty on the control board and refrigeration system, 1-year on all other parts.', specs: ['Sensit delivery system', 'Refrigerated', '72"H x 35"W x 35"D'], price: '$6,663', img: '/static-assets/vvs_product_catalog/images/ams/ams-low-temp-4wide-single-coil.png', coilImg: '/static-assets/vvs_product_catalog/images/ams/single-coil-dual-coil-comparison.png', badgeCombo: true },
  { id: 'amslowtempdual', category: 'combo', brand: 'AMS', name: 'AMS Low Temp 4 Wide (Dual Spiral Coil)', desc: 'Rugged and reliable snack vending with modern electronics. The dual-spiral configuration supports a range of snack and candy package sizes, while the Sensit delivery system confirms each selected product reaches the delivery area. Backed by a 3-year warranty on the control board, 1-year on all other parts.', specs: ['Dual spiral', 'Sensit delivery system', 'Refrigerated'], price: '$6,787', img: '/static-assets/vvs_product_catalog/images/ams/ams-low-temp-4wide-dual-coil.png', coilImg: '/static-assets/vvs_product_catalog/images/ams/single-coil-dual-coil-comparison.png', badgeCombo: true },
  { id: 'amsvrm', category: 'beverage', brand: 'AMS', name: 'AMS VRM Outdoor Vending Machine', desc: 'Outdoor and high-security vending, engineered for outdoor installations and demanding environments', specs: ['Weather resistant', 'High-security design', 'Refrigerated'], price: '$8,204', img: '/static-assets/vvs_product_catalog/images/ams/ams-vrm-outdoor.png', badgeBev: true },
  ...
  { id: 'evoke10drink', category: 'beverage', brand: 'USI', name: 'Evoke Ten Drink', desc: 'High-capacity cold drink machine for cans and bottles', specs: ['10 selections', 'Refrigerated', 'High volume'], price: '$6,114', img: '/static-assets/vvs_product_catalog/images/evoke-10-drink-1.png', badgeBev: true },
...
export default function VendingMachines() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setForm({ name: '', email: '', phone: '', message: '', sms_consent: false });
      setSent(true);
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            {[
              ...
              { q: 'What brands of vending machines do you carry?', a: 'We carry and distribute the most reputable and established vending machine brands in the U.S. We offer full equipment lines from USI and AMS. We also offer quality used and fully refurbished equipment for operators who want faster ROI or a lower upfront investment. Contact us to see what\'s currently available.' },
            ...
            <div className="bg-white rounded-2xl overflow-hidden w-full" style={{ maxWidth: 880, maxHeight: '90vh', overflowY: 'auto' }} onClick={e => e.stopPropagation()}>
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-6 lg:p-8">
                  ...
                  {m?.coilImg && (
                    <div className="mb-6">
                      <div className="font-semibold text-sm mb-3" style={{ color: '#1B2A4A' }}>Single Coil vs. Dual Coil</div>
                      <img src={m.coilImg} alt="Single coil vs. dual coil comparison" className="w-full rounded-xl" style={{ border: '1px solid rgba(27,42,74,0.08)' }} />
                    </div>
                  )}
...
const EMPTY_VM_FORM = { first_name: '', last_name: '', email: '', phone: '', message: '', sms_consent: false };

function VendingMachineForm() {
  const [showModal, setShowModal] = useState(false);
  const [submitted, setSubmitted] = useState(false);
  const [data, setData] = useState(EMPTY_VM_FORM);
