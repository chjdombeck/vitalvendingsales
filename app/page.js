      ...
      <section id="smart-coolers" className="bg-white py-10 lg:py-28" style={{ backgroundImage: 'radial-gradient(ellipse 50% 40% at 80% 50%, rgba(61,181,74,0.06) 0%, transparent 70%)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-14">
            ...
            <p style={{ color: '#3D4D5C', lineHeight: 1.7 }}>HAHA Smart Coolers are our most popular AI-powered solution, with over 100 units deployed throughout New England. We also offer additional smart cooler solutions, including USI Spectra, to ensure every customer has the right fit for their business.</p>
          </div>
