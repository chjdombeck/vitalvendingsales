...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={s.p}>Pricing note: functional beverages carry higher wholesale costs. A Premier Protein shake costs $2.50 to $3.00 wholesale. Retail at $4.00 to $5.00 to maintain margin. Location type matters. Gym and fitness center locations support premium functional beverage pricing far better than manufacturing break rooms.</p>
