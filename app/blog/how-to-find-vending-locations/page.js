...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={s.p}>Most locations expect a commission, typically 10 to 25% of gross sales, in exchange for the placement. A machine generating $1,000/month in gross sales at a 20% commission pays $200 to the location and nets $800 to you before cost of goods. Some locations will waive commission in exchange for service quality. Lead with free service first and structure commission as a revenue share if the machine performs above a baseline. This framing reduces objection from uncertain location managers.</p>

      <h2 style={s.h2}>Best Location Types in the Northeast</h2>
      <ul style={s.ul}>
        <li style={s.li}><strong>Offices (50+ employees):</strong> Reliable foot traffic, predictable schedules, strong cashless adoption. Best for combo machines and AI smart coolers. Mid-market and professional services firms often lack in-house employee food programs, an easy entry point.</li>
        ...
        <li style={s.li}><strong>Hotels:</strong> 24/7 traffic from guests and staff. Hotel management companies often manage multiple properties, so one relationship can yield multiple placements.</li>
        <li style={s.li}><strong>Car Dealerships:</strong> Waiting customers with time on their hands and no food options. Surprisingly high transaction values due to dwell time. Most dealerships have no vending at all, an easy first call near an auto corridor.</li>
