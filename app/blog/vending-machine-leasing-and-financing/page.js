...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={s.p}>The Small Business Administration&apos;s flagship 7(a) loan program offers some of the most favorable terms available for small business equipment purchases — rates typically prime plus 2.25–2.75%, with terms up to 10 years on equipment. For a $25,000 equipment loan, that translates to monthly payments around $265–$285 at current rates, significantly lower than most conventional equipment loans. The catch: the approval process is longer (typically 30–90 days) and requires more documentation, including a business plan, personal financial statements, and tax returns.</p>
      <p style={s.p}>SBA loans are best suited for operators who have been in business at least two years, have solid credit (650+), and are making a significant equipment investment ($10,000+). For a first-time operator buying a single machine, the SBA process is likely overkill. But for an operator acquiring a 10-machine route or purchasing a significant micro-market setup, the interest savings over the loan term can be substantial — often $3,000–$8,000 compared to conventional equipment financing.</p>
