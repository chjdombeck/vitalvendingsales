...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={s.p}>Offer existing location contacts a cash fee, typically $100 to $300, for every new location they refer that you close. Office managers talk to other office managers. Gym owners know other gym owners. Keep it simple: one email explaining the program and prompt payment when deals close.</p>
