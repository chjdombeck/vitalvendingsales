...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={s.p}>This architecture enables a fundamentally different product category: fresh, refrigerated, grab-and-go food that would be impractical in a traditional machine. Average transaction values in AI smart coolers run $4.50 to $6.00 compared to $1.50 to $2.50 in traditional machines, a revenue-per-interaction improvement that has fundamentally changed the economics of unattended retail.</p>
