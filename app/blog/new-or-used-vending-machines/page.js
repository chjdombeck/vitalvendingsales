...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={s.p}>Most new machines built after 2020 include a cashless reader slot as standard. Used machines from before 2018 usually require aftermarket retrofit kits, typically $200 to $500 per unit for a Nayax or Cantaloupe device. Budget $300 per used unit for cashless as a rule of thumb and factor that into your total acquisition cost comparison.</p>

      <h2 style={s.h2}>Factor 3: Energy Efficiency</h2>
      <p style={s.p}>Refrigerated vending machines run 24 hours a day, 365 days a year. Older compressors consume 8 to 15 kWh daily. Current Energy Star models run at 3 to 5 kWh. At Northeast commercial electricity rates of $0.18 to $0.22 per kWh, that difference translates to $150 to $300 per year per machine, or $1,500 to $3,000 annually across a 10-machine route. Over a five-year ownership horizon, the energy savings on new machines partially offset the higher purchase price.</p>
      ...
      <p style={s.p}>A machine generating $400 per month in commissions at a 20% margin produces $80/month in profit. At $2,000 purchase price, break-even is 25 months. At $6,000, it is 75 months. Budget an extra $200 to $400 per year for maintenance on used equipment, but the break-even advantage is still substantial.</p>
