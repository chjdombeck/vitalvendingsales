      ...
      <section className="py-14 lg:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ul style={ul}>
            ...
            <li style={p}>Reply <strong>STOP</strong> at any time to opt out of text messages.</li>
            <li style={p}>Reply <strong>HELP</strong> for assistance.</li>
            <li style={p}>Consent to receive text messages is not a condition of any purchase.</li>
            <li style={p}>Carriers are not liable for delayed or undelivered messages.</li>
          </ul>
          <p style={p}>We do not sell or share your mobile number or SMS opt-in data with third parties for their own marketing purposes. Mobile opt-in and phone numbers are used solely by Vital Vending Sales for the purposes described above.</p>
          ...
          <h2 style={h2}>5. Information Sharing</h2>
          ...
          <ul style={ul}>
            <li style={p}><strong>Service providers:</strong> We use Stripe for payment processing, and HubSpot and Go High Level as our customer relationship management (CRM) and communications platforms to manage consultation requests, inquiries, and text/email communications submitted through our contact forms. These providers receive only the information necessary to process your transaction or request.</li>
