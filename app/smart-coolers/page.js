...
const HAHA_PRODUCTS = [
  ...
  { id: 'haha-max-660', img: '/static-assets/MoreVendingMachinesandContent/Max 660 Details.webp', name: 'HAHA 660 Max', model: 'US660 Max', tagline: 'Our largest single-door cooler, built for capacity', specs: ['480 bottles', '6 shelves', 'AI recognition'], price: '$4,999', badge: 'AI Smart Cooler', badgeStyle: {} },
...
const MODAL_DATA = {
  ...
  'haha-max-660': {
    name: 'HAHA 660 Max', model: 'US660 Max', brand: 'HAHA Smart Coolers', category: 'AI Smart Cooler', price: '$4,999',
    img: '/static-assets/MoreVendingMachinesandContent/Max 660 Details.webp', images: [],
    specs: ['Exterior Dimensions: 31.5" x 28.0" x 79.5"', 'Shelves: 6 shelves, customizable', 'Approximate Capacity: ~480 bottles', 'Interior Capacity: ~22.3 cu ft', 'Connectivity: SIM or WiFi', 'Payment: Card, Apple Pay, Google Pay'],
    features: 'Our largest single-door compact AI vending machine, the HAHA 660 Max holds up to 480 bottles across 6 adjustable shelves, so you spend less time restocking. AI-powered cameras track inventory, sales, and security through the HAHA Vending app, with fast, cashless checkout for shoppers.',
    featureCardsTitle: 'Why HAHA: Built Different. Built Better.',
    featureCards: [
      { icon: '🧠', title: 'AI Recognition That Works', body: 'AI vision recognition with 99% accuracy and no weights or recalibration required. Order speed of about 60 seconds, with new product learning in under 6 hours.' },
      { icon: '📦', title: 'Large Compact Smart-Capacity', body: 'Holds up to 480 bottles across 6 adjustable shelves (5 shelves of 500ml bottled products plus 1 shelf of 330ml canned goods).' },
      { icon: '🔒', title: 'Anti-Theft Armored Door', body: 'Aluminum alloy door with anti-fog glass and a spring-loaded piston lock. Long-lasting, durable, and secure every time.' },
      { icon: '🌡️', title: 'Flexible Cooling System', body: 'Single-temperature cooling from 32°F to 50°F, ideal for combo-refrigerated products with automatic water evaporation management.' },
      { icon: '📱', title: 'Integrated Mobile App', body: 'Simple operation with constant inventory control. Remote marketing, payment, and camera security, all from the HAHA mobile app.' },
      { icon: '🔋', title: 'Backup Power & Certified Safe', body: 'UPS backup power source for emergency outages. Certified by ETL for safe working temperatures and conditions (110V-120V, 60Hz).' },
    ],
    costRows: [
      ['Monthly Platform Fee', '$15/mo', 'SIM card (can be avoided using WiFi/Cable)'],
      ['HAHA Vending App Fee', '$15/mo', 'AI identification: $0.05/transaction'],
      ['Card Reader POS Fee', '$10/mo', 'PAX credit card reader equipped'],
      ['Payment Processing Fee', '5.95%', 'Sales only'],
      ['Shipping', '$495', 'Fixed shipping cost, single machine'],
    ],
    costNote: 'Accepts credit/debit cards, Apple Pay, Google Pay, Samsung Pay, and other cashless methods via the equipped PAX credit card reader. Backed by a 1-year parts warranty and 24/7 lifetime technical support.',
    pdfHref: '/static-assets/MoreVendingMachinesandContent/APP Instructions (1) (1).pdf',
    pdfLabel: 'Download HAHA App User Guide',
    comparisonImage: '/static-assets/MoreVendingMachinesandContent/Pros of smart vending VS. Traditional Vending .jpg',
  },
